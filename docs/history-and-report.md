...
Off until you switch it on, under **Settings → Word-Smith → History** — or from the **Start counting** button on the History tab itself.
...
`{report}` on the bar, or the menu, opens a panel with two tabs — this note, and its folder — each showing **words**, **characters**, **syllables**, **sentences**, **paragraphs**, **pages**, **read time** and a **reading grade**. Hover any figure and it explains itself.
...
Hit a target and the figure turns and stays turned — the gauge fills and the status bar marks it.
