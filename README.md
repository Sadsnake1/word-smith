...
[The Organizer](#the-organizer) · [Writing modes](#writing-modes) · [Themes](#themes) · [The powerline bar](#the-powerline-bar) · [Export](#export) · [Writing history and the report](#writing-history-and-the-report) · [And the rest](#and-the-rest) · [Install](#install) · [Five minutes in](#five-minutes-in) · [Docs](#docs)
...
Read more about [the Organizer](docs/organizer.md).
...
Read more about [writing modes](docs/writing-modes.md).
...
Read more about [themes](docs/themes.md).
...
Read more about [the powerline bar](docs/powerline.md).
